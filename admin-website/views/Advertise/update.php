<?php 
      ...
      <?php 
        if(isset($_GET['id'])) {
          $record = $Advertise->prepare($_GET)->fetch();
          if(!$record) {
                      ...
                      <form method="post" enctype="multipart/form-data">
                        <div class="col-md-6 left-part">
                              ...
                              <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Category" name="category" type="text" value="<?php if(isset($record)){echo $record->category;} ?>">
                              </div>                           
                              <div class="form-group">
                                <input type="hidden" value="<?php if(isset($record)) {echo $record->id;} ?>" name="id">
                                <input class="form-control" placeholder="Links" name="links" type="text" value="<?php if(isset($record)){echo $record->links;} ?>">
                              </div>
                              ...
                              <div class="form-group">
                                <div class="row">
                                    <?php if (!empty($record->file)): ?>
                                      <div class="col-md-5">
                                        <h5>Current image</h5>
                                        <img src="../<?php if(isset($record)) { echo $Advertise->image_path()."/".$record->file;}?>" class="img-thumbnail file">
