<?php
	if(isset($_POST['btn-del'])) {
		$Subscribe->prepare($_GET)->delete();
		$session->set_message("data deleted successfully.");
		Helper::redirect_to("index.php?page=Subscribe_read");
	}
 ?>
            ...
            <div id="body-collapse" class="panel-collapse collapse in">
               <div class="row main-part">
				...
				<?php if(isset($_GET['id'])) { 
					$record = $Subscribe->prepare($_GET)->fetch();
					if($record) { ?>
						...
						<form method="post">
							...
							<a class="btn btn-primary" href="index.php?page=Subscribe_read"> <span class="glyphicon glyphicon-backward"></span> Cancel</a>	
						</form>
					<?php } else { ?>						
							<div class="alert alert-info">
						    	<strong>SORRY!</strong> No Record Found. <a href="index.php?page=Subscribe_read">HOME</a>!
							</div>						
					<?php } ?>
			<?php } ?>
