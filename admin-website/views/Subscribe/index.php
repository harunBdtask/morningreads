<?php
	...
	$rec = $Subscribe->count_all(); 	
	$page = !empty($_GET['rows']) ? (int)$_GET['rows'] : 1;
	$per_page = $Subscribe->per_page;	
	$total_count = $rec->total;
	$pagination = new Pagination($page, $per_page, $total_count);
	$Subscribe->offset = $pagination->offset();
	$records = $Subscribe->read();
 ?>
          ...
          <div class="panel panel-default main-body">
            <div class="panel-heading body-head">
              <h4 class="panel-title">                 
                ...
                <span class="glyphicon glyphicon-plus"></span>&nbsp;Subscribe</a>
              </h4>
            </div>
										...
										<?php foreach ($records as $record) { ?>
											<tr class="">
												...
												<td class="text-center">
													<a href="index.php?page=Subscribe_delete&id=<?php echo $record->id; ?>"><span class="glyphicon glyphicon-remove-circle"></span></a>
												</td>
											</tr>
										<?php } ?>
									</table>
								...
								<?php 
									...
									echo "<ul class=\"pagination\">";
										if($pagination->has_previous_page()) { 
								    		echo "<li><a href=\"index.php?page=Subscribe_read&rows=";
										...
										for($i=1; $i <= $pagination->total_pages(); $i++) {
											if($i == $page) {
												...
												echo " <li><a href=\"index.php?page=Subscribe_read&rows={$i}\">{$i}</a></li> "; 
											}
										}
    ...
    <script>
	   ...
	   function get() {
	    	...
	    	$.ajax({
		        type: "POST",
		        url: "../views/Subscribe/search.php",
		        data:'find='+val,
		        beforeSend: function() {
		        	$('#animate').show();
		        },
