<?php
	if(isset($_POST['btn-del'])) {
		$Author->prepare($_GET)->delete();
		$session->set_message("data deleted successfully.");
		Helper::redirect_to("index.php?page=Author_read");
	}
 ?>
				...
				<?php if(isset($_GET['id'])) { 
					...
					if($record) { ?>
						...
						<form method="post">
							...
							<a class="btn btn-primary" href="index.php?page=Author_read"> <span class="glyphicon glyphicon-backward"></span> Cancel</a>	
						</form>
					<?php } else { ?>						
							<div class="alert alert-info">
						    	<strong>SORRY!</strong> No Record Found. <a href="index.php?page=Author_read">HOME</a>!
							</div>						
					<?php } ?>
			<?php } ?>
