            ...
            <div id="body-collapse" class="panel-collapse collapse in">
               <div class="row main-part">
                  <div class="col-md-12 inner-part">
						...
						<a class="btn btn-primary" href="index.php?page=Tags_create"><span class="glyphicon glyphicon-plus"></span> Add Record</a><br><br>
						<?php 
								...
								<?php 
									...
									echo "<ul class=\"pagination\">";
										if($pagination->has_previous_page()) { 
								    		echo "<li><a href=\"index.php?page=Tags_read&rows=";
										...
										for($i=1; $i <= $pagination->total_pages(); $i++) {
											if($i == $page) {
												...
												echo " <li><a href=\"index.php?page=Tags_read&rows={$i}\">{$i}</a></li> "; 
											}
										}
