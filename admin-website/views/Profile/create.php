<?php 
      if(isset($_POST['btn-save'])) {
        if(isset($_FILES['file']) && $_FILES['file']['error'] == 0) {
          $Profile->attach($_FILES['file']);
        }
        if($Profile->prepare($_POST)->save()) {
          $session->set_message("data inserted successfully.");
          Helper::redirect_to("index.php?page=Profile_create");
        } else {
          $session->set_message($Profile->errors);
        }
      }
     ?>
          ...
          <div class="panel panel-default main-body">
            <div class="panel-heading body-head">
              <h4 class="panel-title">                 
                ...
                <span class="glyphicon glyphicon-plus"></span>&nbsp;Profile</a>
              </h4>
            </div>
                      ...
                      <form method="post" enctype="multipart/form-data">
                        <div class="col-md-6 left-part">
                             ...
                             <div class="form-group">
                                <input class="form-control" placeholder="Name" name="title" type="text" value="<?php if(isset($_POST['title'])) { echo $_POST['title']; } ?>">
                              </div>
                        ...
                        <div class="col-md-12 submit">
                            ...
                            <a href="index.php?page=Profile_read" class="btn btn-success"><span class="glyphicon glyphicon-backward"></span>&nbsp; Cancel</a>                  
                        </div><!-- End of submit -->
                      </form>
                    </div><!-- End of section -->
