          ...
          <div class="panel panel-default main-body">
            <div class="panel-heading body-head">
              <h4 class="panel-title">                 
                ...
                <span class="glyphicon glyphicon-plus"></span>&nbsp;Images</a>
              </h4>
            </div>
            <div id="body-collapse" class="panel-collapse collapse in">
               <div class="row main-part">
                  <div class="col-md-12 inner-part">
						...
						<a class="btn btn-primary" href="index.php?page=Images_create"><span class="glyphicon glyphicon-plus"></span> Add Record</a><br><br>
						<?php 
									...
									<table class="table table-bordered">
										...
										<?php foreach ($records as $record) { ?>
											<tr class="">
												...
												<td><img src="../<?php if(isset($record)) { echo $Images->image_path()."/".$record->file;}?>" class="img-thumbnail file"></td>
												
												
												<td class="text-center">
													<a href="index.php?page=Images_update&id=<?php echo $record->id; ?>"><span class="glyphicon glyphicon-edit"></span></a>
													<a href="index.php?page=Images_delete&id=<?php echo $record->id; ?>"><span class="glyphicon glyphicon-remove-circle"></span></a>
												</td>
											</tr>
										<?php } ?>
									</table>
								...
								<?php 
									...
									echo "<ul class=\"pagination\">";
										if($pagination->has_previous_page()) { 
								    		echo "<li><a href=\"index.php?page=Images_read&rows=";
										...
										for($i=1; $i <= $pagination->total_pages(); $i++) {
											if($i == $page) {
												...
												echo " <li><a href=\"index.php?page=Images_read&rows={$i}\">{$i}</a></li> "; 
											}
										}
