<?php 
  if(isset($_POST['btn-save'])) {
    $checkBox = implode(',', $_POST['tags']);
    
    if(isset($_FILES['file']) && $_FILES['file']['error'] == 0) {
      $Images->attach($_FILES['file']);
    }
    if($Images->prepare($_POST)->save()) {
      $session->set_message("data inserted successfully.");
      Helper::redirect_to("index.php?page=Images_create");
    } else {
      $session->set_message($Images->errors);
    }
  }
 ?>
                    ...
                    <div class="row section">
                      <form method="post" enctype="multipart/form-data">
                        <div class="col-md-6 left-part">
                              <legend>Images Details</legend>                            
                            <div class="form-group">
                                <input class="form-control" placeholder="Images Name" name="title" type="text" value="<?php if(isset($_POST['title'])) { echo $_POST['title']; } ?>">
                            </div>                                                                               
                        ...
                        <div class="col-md-12 submit">
                            ...
                            <a href="index.php?page=Images_read" class="btn btn-success"><span class="glyphicon glyphicon-backward"></span>&nbsp; Cancel</a>                  
                        </div><!-- End of submit -->
                      </form>
                    </div><!-- End of section -->
