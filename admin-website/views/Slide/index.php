<?php
	...
	$per_page = $Slide->per_page;	
	$total_count = $rec->total;
	$pagination = new Pagination($page, $per_page, $total_count);
	$Slide->offset = $pagination->offset();
	$records = $Slide->read();
 ?>
            ...
            <div id="body-collapse" class="panel-collapse collapse in">
               <div class="row main-part">
                  <div class="col-md-12 inner-part">
						...
						<a class="btn btn-primary" href="index.php?page=Slide_create"><span class="glyphicon glyphicon-plus"></span> Add Record</a><br><br>
						<?php 
								...
								<?php 
									...
									echo "<ul class=\"pagination\">";
										if($pagination->has_previous_page()) { 
								    		echo "<li><a href=\"index.php?page=Slide_read&rows=";
										...
										for($i=1; $i <= $pagination->total_pages(); $i++) {
											if($i == $page) {
												...
												echo " <li><a href=\"index.php?page=Slide_read&rows={$i}\">{$i}</a></li> "; 
											}
										}
