                    ...
                    <div class="row section">
                      ...
                      <form method="post" enctype="multipart/form-data">
                        <div class="col-md-6 left-part">
                              ...
                              <div class="form-group">
                                <input type="hidden" value="<?php if(isset($record)) {echo $record->id;} ?>" name="id">
                                <textarea class="form-control" placeholder="Description" name="des"><?php if(isset($record)){echo $record->des;} ?></textarea>
                              </div>
                              ...
                              <div class="form-group">
                                <div class="row">
                                    <?php if (!empty($record->file)): ?>
                                      <div class="col-md-5">
                                        <h5>Current image</h5>
                                        <img src="../<?php if(isset($record)) { echo $Slide->image_path()."/".$record->file;}?>" class="img-thumbnail file">
