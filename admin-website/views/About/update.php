<?php 
      ...
      if(isset($_POST['btn-update'])) {
        ...
        if(isset($_FILES['file']) && $_FILES['file']['error'] == 0) {
          $About->attach($_FILES['file']);   
        }
        if($About->prepare($_POST)->save()) {
          $session->set_message("data updated successfully.");
        } else {
          $session->set_message($About->errors);
        }
      }
      ...
      <?php 
        if(isset($_GET['id'])) {
          $record = $About->prepare($_GET)->fetch();
          if(!$record) {
          ...
          <div class="panel panel-default main-body">
            <div class="panel-heading body-head">
              <h4 class="panel-title">                 
                ...
                <span class="glyphicon glyphicon-plus"></span>&nbsp;About</a>
              </h4>
            </div>
                      ...
                      <form method="post" enctype="multipart/form-data">
                        <div class="col-md-6 left-part">
                              ...
                              <div class="form-group">
                                ...
                                <textarea class="form-control" placeholder="About Description" name="des"><?php if(isset($record)){echo $record->des;} ?></textarea>
                              </div>
                              <button type="submit" class="btn btn-primary" name="btn-update">
                                <span class="glyphicon glyphicon-edit"></span> Update Record
                              </button>
                              <a href="index.php?page=About_read" class="btn btn-success"><span class="glyphicon glyphicon-backward"></span>&nbsp; Cancel</a>                  
