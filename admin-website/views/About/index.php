<?php
	...
	$per_page = $About->per_page;	
	$total_count = $rec->total;
	$pagination = new Pagination($page, $per_page, $total_count);
	$About->offset = $pagination->offset();
	$records = $About->read();
 ?>
										...
										<?php foreach ($records as $record) { ?>
											<tr class="">
												...
												<td class="text-center">
													<a href="index.php?page=About_update&id=<?php echo $record->id; ?>"><span class="glyphicon glyphicon-edit"></span></a>
												</td>
											</tr>
										<?php } ?>
									</table>
								...
								<?php 
									...
									echo "<ul class=\"pagination\">";
										if($pagination->has_previous_page()) { 
								    		echo "<li><a href=\"index.php?page=About_read&rows=";
										...
										for($i=1; $i <= $pagination->total_pages(); $i++) {
											if($i == $page) {
												...
												echo " <li><a href=\"index.php?page=About_read&rows={$i}\">{$i}</a></li> "; 
											}
										}
