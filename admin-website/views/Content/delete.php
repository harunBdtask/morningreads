<?php
	if(isset($_POST['btn-del'])) {
		$Content->prepare($_GET)->delete();
		$session->set_message("data deleted successfully.");
		Helper::redirect_to("index.php?page=Content_read");
	}
 ?>
            ...
            <div id="body-collapse" class="panel-collapse collapse in">
               <div class="row main-part">
				...
				<?php if(isset($_GET['id'])) { 
					$record = $Content->prepare($_GET)->fetch();
					if($record) { ?>
						...
						<form method="post">
							...
							<a class="btn btn-primary" href="index.php?page=Content_read"> <span class="glyphicon glyphicon-backward"></span> Cancel</a>	
						</form>
					<?php } else { ?>						
							<div class="alert alert-info">
						    	<strong>SORRY!</strong> No Record Found. <a href="index.php?page=Content_read">HOME</a>!
							</div>						
					<?php } ?>
			<?php } ?>
