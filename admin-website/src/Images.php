...
class Images {
	...
	public function create() {
		...
		//$sql = "insert into ".self::$table."(title, file, category_code, author_code, content_code, tags) VALUES ('$title', '$file', '$category_code', '$author_code', '$content_code', '$tags')";
	...
	public function custom_create($checkBox) {
		//$attributes = $this->attributes();
		array_shift($attributes);
		$sql = "insert into ".self::$table."(tags) VALUES ('" . $checkBox . "')";
